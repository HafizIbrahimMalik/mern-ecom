    ...
    return (
        <div >
            ...
            <Drawer
                ...
                <Box boxSizing={"content-box"} p={2} width='250px' role='presentation' textAlign='center' >
                    <div style={{ paddingLeft: "81px" }}>
                        <Avatar src={logo} sx={{ ml: "20px" }} /></div>
                    <Typography variant='bold' component='h1' mb={5}>
                        TUTU
                    </Typography>
                    <Stack border="dotted" borderColor={"blue"}>
                        {window.location.href === "http://localhost:3000/Dashboard" ? "" : <Button sx={{ mt: 1 }} onClick={() => navigate('/admin/Dashboard')}>Dashboard</Button>}
                        {window.location.href === "http://localhost:3000/create-productCategories" ? "" : <Button sx={{ mt: 1 }} onClick={() => navigate('/admin/create-productCategories')}>Create Product Category</Button>}
                        ...
                        {window.location.href === "http://localhost:3000/product" ? "" : <Button sx={{ mt: 1 }} onClick={() => navigate('/admin/create-user')}>Create User</Button>}
                        {window.location.href === "http://localhost:3000/product" ? "" : <Button sx={{ mt: 1 }} onClick={() => navigate('/admin/users')}>Users</Button>}
